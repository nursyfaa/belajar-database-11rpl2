...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2023 at 04:02 PM
...
--
ALTER TABLE `petugas`
  ADD CONSTRAINT `petugas_ibfk_1` FOREIGN KEY (`id_petugas`) REFERENCES `pembayaran` (`id_petugas`) ON DELETE CASCADE ON UPDATE CASCADE;
